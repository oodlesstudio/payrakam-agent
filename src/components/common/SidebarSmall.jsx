...
const SidebarSmall = (props) => {
    ...
    <Popover id="popover-basic" className="sidebarPopover">
      <Popover.Body>
        <ul className="subMenu">
          <li className={activeLink("/dmt/transfer-money")}>
            <Link to="/dmt/transfer-money">
  ...
  const aepsPopover = (
    <Popover id="popover-basic" className="sidebarPopover">
      <Popover.Body>
        <ul className="subMenu">
          <li className={activeLink("/aeps/transactions")}>
    ...
    <div className="sidebarSmall">
      ...
      <div className="sidebarSmallImg">
        <OverlayTrigger
          ...
          rootClose
        >
          <div className={activeLink("/dmt/transfer-money")}>
      ...
      <div className="sidebarSmallImg">
        <OverlayTrigger
          ...
          rootClose
        >
          <div className={activeLink("/aeps/transactions")}>
